    ...
    <footer id="contact" className="relative bg-gray-900 text-white px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 py-12 lg:py-24">
      <div className="flex flex-col md:flex-row">
        <div className="w-full lg:w-2/6 lg:mx-4 lg:pr-8">
          <h3 className="font-bold text-2xl text-primary">InternLink</h3>
          <p className="text-gray-400">
          Connecting Futures, Forging Careers. Your Gateway to Transformative Internships 
          </p>
          ...
          <ul className="mt-4">
            <li>
              ...
              >
                ...
                <span className="ml-3">KG 541 St, Kigali, Rwanda</span>
              </a>
            </li>
            <li className="mt-4">
              <a
            ...
            <li className="mt-4">
              ...
              >
                ...
                <span className="ml-3">
                  <a href="tel: 0788 303 386"> 0788 303 386</a>
                </span>
              </a>
            </li>
            <li className="mt-4">
              ...
              >
                ...
                <span className="ml-3">universityofkigali@gmail.com</span>
              </a>
            </li>
          </ul>
        </div>
